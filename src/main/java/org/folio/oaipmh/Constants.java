...
public final class Constants {
   ...
   * Represents {@linkplain org.openarchives.oai._2.GranularityType#YYYY_MM_DD_THH_MM_SS_Z
   * YYYY_MM_DD_THH_MM_SS_Z} granularity
   */
  ...
  public static final DateTimeFormatter ISO_UTC_DATE_ONLY =
      DateTimeFormatter.ofPattern(ISO_DATE_ONLY_PATTERN);
  ...
  public static final String JAXB_MARSHALLER_ENABLE_VALIDATION =
      "jaxb.marshaller.enableValidation";
  public static final String REPOSITORY_BASE_URL = "repository.baseURL";
  public static final String REPOSITORY_MAX_RECORDS_PER_RESPONSE =
      "repository.maxRecordsPerResponse";
  public static final String REPOSITORY_SRS_HTTP_REQUEST_RETRY_ATTEMPTS =
      "repository.srsHttpRequestRetryAttempts";
  public static final String REPOSITORY_SRS_CLIENT_IDLE_TIMEOUT_SEC =
      "repository.srsClientIdleTimeoutSec";
  ...
  public static final String REPOSITORY_SUPPRESSED_RECORDS_PROCESSING =
      "repository.suppressedRecordsProcessing";
  ...
  public static final String REPOSITORY_FETCHING_CLEAN_ERRORS_INTERVAL =
      "repository.cleanErrorsInterval";
  ...
  /**
   * It is used if SRS + Inventory and serves as reduce offset from Inventory once a number
   * of returned SRS records is less than {@link Constants#REPOSITORY_MAX_RECORDS_PER_RESPONSE},
   * so the rest should be from Inventory, but with reduced offset by the number of SRS records
   * returned.
   */
  ...
  public static final String GENERIC_ERROR_MESSAGE =
      "Sorry, we can't process your request. Please contact administrator(s).";
  public static final String CANNOT_DISSEMINATE_FORMAT_ERROR =
      "The value of the MetadataPrefix argument is not supported by the repository";
  public static final String RESUMPTION_TOKEN_FORMAT_ERROR =
      "The value of the resumptionToken argument is invalid";
  public static final String RESUMPTION_TOKEN_FLOW_ERROR =
      "There were substantial changes to the repository and continuing may result in "
      + "missing records.";
  public static final String LIST_NO_REQUIRED_PARAM_ERROR =
      "Missing required parameters: metadataPrefix";
  public static final String LIST_ILLEGAL_ARGUMENTS_ERROR =
      "Verb '%s', argument 'resumptionToken' is exclusive, no others maybe specified with it.";
  public static final String INVALID_RESUMPTION_TOKEN =
      "Verb '%s', argument resumptionToken is invalid";
  public static final String NO_RECORD_FOUND_ERROR =
      "There were no records found matching the search criteria";
  public static final String INVALID_CHARACTER_IN_THE_RECORD =
      "Invalid character in the record.";
  public static final String BAD_DATESTAMP_FORMAT_ERROR =
      "Bad datestamp format for '%s=%s' argument.";
  public static final String RECORD_METADATA_PREFIX_PARAM_ERROR =
      "The request is missing required arguments. There is no metadataPrefix.";
  ...
  public static final String EXPIRED_RESUMPTION_TOKEN =
  ...
  public static final String LOCAL_ERROR_FILE_SAVE_FAILED =
      "Cannot save error to the local file: {}";
  ...
  public static final String LOCAL_ERROR_DIRECTORY_DELETE_FAILED =
      "Cannot delete local directory: {}";

  public static final String SET_FIELD_NULL_VALUE_ERROR_MSG_TEMPLATE =
      "Field '%s' cannot be empty or null";
  ...
  public static final String ELECTRONIC_ACCESS_RELATIONSHIPS_URI =
