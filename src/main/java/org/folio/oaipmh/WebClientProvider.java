...
public class WebClientProvider {
  ...
  private static final String GET_IDLE_TIMEOUT_ERROR_MESSAGE = "Error occurred during resolving "
      + "the idle timeout setting value. Setup client with default idle timeout "
      + DEFAULT_IDLE_TIMEOUT_SEC + " seconds.";
  ...
  private static WebClient createWebClientWithSrsConfiguredOptions(String requestId) {
    String val = RepositoryConfigurationUtil.getProperty(requestId,
        REPOSITORY_SRS_CLIENT_IDLE_TIMEOUT_SEC);
