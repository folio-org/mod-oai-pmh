...
public interface InstancesDao {
  ...
  /**
   * Returns request ids which last updated date is 'expirationPeriodInSeconds'
   * seconds less than the current date.
   */
   ...
   */
  Future<RequestMetadataCollection> getRequestMetadataCollection(int offset, int limit,
        String tenantId);

  Future<UuidCollection> getFailedToSaveInstancesIdsCollection(String requestId, int offset,
      int limit, String tenantId);

  Future<UuidCollection> getSkippedInstancesIdsCollection(String requestId, int offset,
      int limit, String tenantId);

  Future<UuidCollection> getFailedInstancesIdsCollection(String requestId, int offset,
      int limit, String tenantId);

  Future<UuidCollection> getSuppressedInstancesIdsCollection(String requestId, int offset,
      int limit, String tenantId);
  ...
  /**
   * Deletes request metadata by request id. Due to foreign key constraint all instances with
   * such request id will be deleted as well.
   */
