...
public enum Verb {
  ...
  LIST_IDENTIFIERS("ListIdentifiers", of(METADATA_PREFIX_PARAM),
      of(FROM_PARAM, UNTIL_PARAM, SET_PARAM, EXPIRATION_DATE_RESUMPTION_TOKEN_PARAM),
      RESUMPTION_TOKEN_PARAM),
  LIST_METADATA_FORMATS("ListMetadataFormats", EMPTY_SET, of(IDENTIFIER_PARAM), null),
  LIST_RECORDS("ListRecords", of(METADATA_PREFIX_PARAM),
      of(FROM_PARAM, UNTIL_PARAM, SET_PARAM, EXPIRATION_DATE_RESUMPTION_TOKEN_PARAM),
      RESUMPTION_TOKEN_PARAM),
  ...
  Verb(String name, Set<String> requiredParams, Set<String> optionalParams,
    ...
    allParams = concat(concat(requiredParams.stream(), optionalParams.stream()),
        excludeParams.stream()).collect(toSet());
