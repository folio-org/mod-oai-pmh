 ...
 */
public enum Verb {
  GET_RECORD("GetRecord", of(IDENTIFIER_PARAM, METADATA_PREFIX_PARAM, EXPIRATION_DATE_RESUMPTION_TOKEN), EMPTY_SET, null),
  IDENTIFY("Identify", EMPTY_SET, EMPTY_SET, null),
  LIST_IDENTIFIERS("ListIdentifiers", of(METADATA_PREFIX_PARAM), of(FROM_PARAM, UNTIL_PARAM, SET_PARAM, EXPIRATION_DATE_RESUMPTION_TOKEN), RESUMPTION_TOKEN_PARAM),
  LIST_METADATA_FORMATS("ListMetadataFormats", EMPTY_SET, of(IDENTIFIER_PARAM), null),
  LIST_RECORDS("ListRecords", of(METADATA_PREFIX_PARAM), of(FROM_PARAM, UNTIL_PARAM, SET_PARAM, EXPIRATION_DATE_RESUMPTION_TOKEN), RESUMPTION_TOKEN_PARAM),
