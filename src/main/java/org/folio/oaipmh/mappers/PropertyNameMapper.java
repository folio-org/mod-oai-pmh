...
public class PropertyNameMapper {
  ...
  static {
    ...
    frontendToBackendMapper.put("suppressedRecordsProcessing",
    ...
    frontendToBackendMapper.put("srsHttpRequestRetryAttempts",
    ...
    frontendToBackendMapper.put("cleanErrorsInterval", REPOSITORY_FETCHING_CLEAN_ERRORS_INTERVAL);
    frontendToBackendMapper.forEach((key, value) ->
        backendToFrontendMapper.put(value, key));
  }
