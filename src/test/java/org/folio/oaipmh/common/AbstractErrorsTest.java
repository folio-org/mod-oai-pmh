...
public abstract class AbstractErrorsTest {
  ...
  protected static final RequestMetadataLb requestMetadata = new RequestMetadataLb().setRequestId(REQUEST_ID)
  ...
  void setup(VertxTestContext testContext) {
    ...
    errorList.forEach(err -> saveErrorsFutures.add(getErrorsDao().saveErrors(err, OAI_TEST_TENANT)));
