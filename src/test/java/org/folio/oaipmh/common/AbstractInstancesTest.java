...
public abstract class AbstractInstancesTest {
  ...
  protected static final long INSTANCES_EXPIRATION_TIME_IN_SECONDS =
  ...
  protected static final OffsetDateTime notExpiredDate =
  ...
  protected static final Instances instance_1 = new Instances()
      .setInstanceId(UUID.fromString(EXPIRED_INSTANCE_ID))
      .setSuppressFromDiscovery(false)
      .setRequestId(UUID.fromString(EXPIRED_REQUEST_ID));
  protected static final Instances instance_2 = new Instances()
      .setInstanceId(UUID.fromString(INSTANCE_ID))
      .setSuppressFromDiscovery(false)
      .setRequestId(UUID.fromString(REQUEST_ID));

  protected static final List<Instances> instancesList = List.of(instance_1, instance_2);
  protected static final List<RequestMetadataLb> requestMetadataList =
      List.of(expiredRequestMetadata, requestMetadata);
