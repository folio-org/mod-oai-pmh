 ...
 void testParserHandleValidData() {
  ...
  void testParserHandleInternalError() {
    ...
    var jsonParser = new OaiPmhJsonParser()
      .objectValueMode()
      .handler(handler -> {
        throw new ClassCastException("class java.lang.String cannot be cast to class io.vertx.core.json.JsonObject (java.lang.String is in module java.base of loader 'bootstrap'; io.vertx.core.json.JsonObject is in unnamed module of loader 'app')");
      })
